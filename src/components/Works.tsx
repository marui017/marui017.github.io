...
export default function Works() {
  ...
  useEffect(() => {
    setCurrentIndex((i) =>
      Math.min(i, Math.max(0, works.length - slidesPerView)),
    );
  }, [slidesPerView]);
    ...
    <section id="works" className="p-works">
      <div className="l-inner">
        ...
        <div className="p-works__btn-wrap">
          <Link to="/works" className="c-button c-button--outline">
            制作実績一覧
          </Link>
        </div>
      </div>
