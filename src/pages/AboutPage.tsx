...
const skillGroups = [
  {
    category: "Webデザイン",
    description:
      "ワイヤーフレームの作成からビジュアルデザインまで対応。見やすく伝わるデザインを提案します。",
    tools: ["Figma", "Adobe XD", "Illustrator", "Photoshop"],
  },
  {
    category: "Web制作・コーディング",
    description:
      "デザインを忠実にコーディング。スマートフォン対応（レスポンシブ）も標準で対応します。",
    tools: [
      "HTML",
      "CSS / SCSS",
      "JavaScript",
          ...
          <div className="p-about-page__profile">
            ...
            <div className="p-about-page__bio">
              ...
              <p className="p-about-page__text">
                ...
                <br />
                <br />
                デザインツールはFigmaを主に使用。コーディングはHTML / CSS /
                JavaScript、 ReactやTypeScriptにも対応しています。
              </p>
            </div>
          </div>
            ...
            <div className="p-about-page__skill-grid">
              {skillGroups.map((group) => (
                <div key={group.category} className="p-about-page__skill-card">
                  <h3 className="p-about-page__skill-category">
                    {group.category}
                  </h3>
                  <p className="p-about-page__skill-desc">
                    {group.description}
                  </p>
                  <ul className="p-about-page__skill-tags">
                    {group.tools.map((tool) => (
                      <li key={tool} className="p-about-page__skill-tag">
                        {tool}
                      </li>
                    ))}
                  </ul>
